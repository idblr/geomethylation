...
wilcox.test(
  STAGElow$HOXA7.Plasma,
  STAGEhigh$HOXA7.Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
...
wilcox.test(
  STAGElow$SOX17..Plasma,
  STAGEhigh$SOX17..Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
...
wilcox.test(
  STAGElow$ZPF42..Plasma,
  STAGEhigh$ZPF42..Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
...
wilcox.test(
  STAGElow$TAC1.Plasma,
  STAGEhigh$TAC1.Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
...
wilcox.test(
  STAGElow$HOXA9.Plasma,
  STAGEhigh$HOXA9.Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
...
wilcox.test(
  STAGElow$CDO1.Plasma,
  STAGEhigh$CDO1.Plasma,
  mu = 0,
  alt = 'two.sided',
  paired = FALSE,
  conf.int = TRUE,
